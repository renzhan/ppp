...
export interface DataPersistenceService {
  ...
  /** 查找项目基础信息 */
  findProject(projectId: string): Promise<{ startDate: Date | null; endDate: Date | null; brand: string; category: string; executionStartDate: Date | null; lingxiAccountId: string | null; lingxiTaxonomyPath: string | null } | null>;
  /** 查找项目底表中的所有 noteId */
...
export class PrismaDataPersistenceService implements DataPersistenceService {
  ...
  async findProject(projectId: string): Promise<{ startDate: Date | null; endDate: Date | null; brand: string; category: string; executionStartDate: Date | null; lingxiAccountId: string | null; lingxiTaxonomyPath: string | null } | null> {
