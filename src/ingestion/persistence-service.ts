...
export interface DataPersistenceService {
  ...
  /** 查找项目基础信息 */
  findProject(projectId: string): Promise<{ endDate: Date | null; brand: string; category: string; executionStartDate: Date | null; lingxiAccountId: string | null; lingxiTaxonomyPath: string | null } | null>;
  /** 查找项目底表中的所有 noteId */
...
export class PrismaDataPersistenceService implements DataPersistenceService {
  ...
  async findProject(projectId: string): Promise<{ endDate: Date | null; brand: string; category: string; executionStartDate: Date | null; lingxiAccountId: string | null; lingxiTaxonomyPath: string | null } | null> {
    return prisma.project.findUnique({
      where: { id: projectId },
      select: { endDate: true, brand: true, category: true, executionStartDate: true, lingxiAccountId: true, lingxiTaxonomyPath: true },
    });
  }
